                            ...
                            <tbody>
                                ...
                                ?>
                                    <tr>
                                        ...
                                        <td>
                                            <a href="<?= ($partner_id == 3) ? 'cash_invoice.php' : 'print_invoice.php' ?>?invoice_no=<?php echo $invoice_no; ?>" target="_blank" class="btn btn-primary">Print</a><br>
                                            <a href="<?= ($partner_id == 3) ? 'dwnch_invoice.php' : 'invoice.php' ?>?invoice_no=<?php echo $invoice_no; ?>" target="_blank" class="btn btn-primary mt-2">Download</a><br>
