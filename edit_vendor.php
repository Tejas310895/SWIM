                        ...
                        <div class="row">
                            ...
                            <div class="form-group row">
                                ...
                                <select class="form-control" name="vendor_status" id="vendor_status">
                                    <option value="<?php echo $vendor_status; ?>"><?php if($vendor_status==='true'){echo"Active";}else{echo"Inactive";} ?></option>
                                    <option value="<?php if($vendor_status==='true'){echo"false";}else{echo"true";} ?>"><?php if($vendor_status==='true'){echo"Inactive";}else{echo"Active";} ?></option>
                                </select>
                                </div>
                            </div>
                            </div>
